...
func WriteJSON(response http.ResponseWriter, status int, data any, headers ...http.Header) error {
...
func ErrorJSON(response http.ResponseWriter, err error, status ...int) error {
